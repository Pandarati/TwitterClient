# Project 2 - *Jonathan's Twitter Client*

**Jonathan's Twitter Client** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
- [ ] Reading the users habits to predict specific tweets
...
<img src='https://github.com/Pandarati/TwitterClient/blob/master/walkthrough2_replace.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

Using the Correct Read Me format. Getting the word count to work
...
## License
    ...
    Copyright 2020 Jonathan McKinley
